...
public class InMemoryUserService extends BaseUserService {
    ...
    public Identity doSave(Identity user) {
    	Console.println("***** InMemoryService SAVING IDENTITY");
    ...
    public void doSave(Token token) {
    	Console.println("***** InMemoryService SAVING TOKEN");
        tokens.put(token.uuid, token);
    }

    @Override
    public Token doFindToken(String tokenId) {
    	Console.println("***** InMemoryService FINDING TOKEN");
    ...
    public void doDeleteToken(String uuid) {
    	Console.println("***** InMemoryService DELETING TOKEN");
        tokens.remove(uuid);
    }

    @Override
    public void doDeleteExpiredTokens() {
    	Console.println("***** InMemoryService DELETED EXPIRED TOKENS");
	...
	public Identity doFind(IdentityId userId) {
		Console.println("***** InMemoryService FINDING USER");
